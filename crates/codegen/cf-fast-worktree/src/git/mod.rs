...
//!
//! This module isolates git-specific functionality (worktree creation, status,
//! index refresh, delete-safety gating, and stale-registration scrubbing) from
//! filesystem copy logic and orchestration.
